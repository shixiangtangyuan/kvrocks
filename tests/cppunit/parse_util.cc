...
TEST(ParseUtil, TryParseInt) {
  ...
  ASSERT_EQ(TryParseInt("hello").Msg(), "value is not an integer or out of range");
...
TEST(ParseUtil, ParseInt) {
  ...
  ASSERT_EQ(ParseInt("hello").Msg(), "value is not an integer or out of range");
  ASSERT_EQ(ParseInt("123hello").Msg(), "encounter non-integer characters");
  ASSERT_FALSE(ParseInt("9999999999999999999999999999999999"));
  ASSERT_EQ(ParseInt<short>("99999").Msg(), "value is not an integer or out of range");
  ASSERT_EQ(*ParseInt<short>("30000"), 30000);
  ASSERT_EQ(*ParseInt<int>("99999"), 99999);
  ASSERT_EQ(ParseInt<int>("3000000000").Msg(), "value is not an integer or out of range");
